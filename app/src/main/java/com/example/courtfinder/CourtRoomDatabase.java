...
public abstract class CourtRoomDatabase extends RoomDatabase {
    ...
    private static CourtRoomDatabase INSTANCE;

    public static CourtRoomDatabase getDatabase(final Context context) {
        if (INSTANCE == null) {
            synchronized (CourtRoomDatabase.class) {
                if (INSTANCE == null) {
                    // Create database here.
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            CourtRoomDatabase.class, "Court_database")
